...
const sections = [
  ...
  { title: "Data retention", body: "Enquiry data is kept for up to 24 months. Records relating to delivered treatment are retained by the treating hospital in line with Turkish medical record requirements." },
